    ...
    <div className="w-full flex flex-col justify-center items-center  px-6">
      ...
      >
        ...
        <input
          ...
          id="name"
          name="name"
          placeholder="Inserte el nombre del animal"
        ...
        <input
          ...
          id="name"
          name="name"
          placeholder="Inserte la edad aparente del animal"
          onChange={(e) => setName(e.target.value)}
        />
         <label
          className="w-full flex justify-start text-lg md:text-2xl "
        ...
        <input
          ...
          id="name"
          name="name"
          placeholder="Inserte el tamaño aparente del animal (kg)"
          onChange={(e) => setName(e.target.value)}
        />
        <label
          className="w-full flex justify-start text-lg md:text-2xl "
